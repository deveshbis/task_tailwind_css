    ...
    <div>
      ...
      <header>
        ...
        <div class="flex justify-center items-center">
          <span class="bg-[#EBFF3D] p-5 text-4xl mt-10 rounded-[5px]">
        ...
        <div>
          <iframe
            width="560"
            height="315"
            class="mx-auto mt-10 w-[1000px] h-[606px]"
        ...
        <button
          class="flex justify-center items-center gap-3 mx-auto mt-5 bg-[#1B4B36] text-[#EBFF3D] px-4 py-2 rounded-3xl text-xl font-bold mb-5">
